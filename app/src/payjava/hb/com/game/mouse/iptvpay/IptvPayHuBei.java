...
public class IptvPayHuBei {
     ...
     * 16 -- 必杀         3
     */
    private static String[] productIds = {"tvp135513001", "tvp135513002",
            "tvp135513003", "tvp135513004", "tvp135513004",
            "tvp135513006","tvp135513005", "tvp135513007",
            "tvp135513008", "tvp135513009", "tvp135513010",
            "tvp135513011","tvp135513012","tvp135513013",
            "tvp135513014","tvp135513015","tvp135513016"};

    private static String[] prices = {"3", "3",
            "1", "3", "3",
            "3","3", "3",
            "3", "3","3",
            "3","1","3",
    ...
    private static String key = "5421059117184316757";

    private static String cpId = "tvc135";

    private static String gameId = "tvg135513";
    ...
    public static IptvPayHuBei instance;

    public Activity activity;

    public static IptvPayHuBei getInstance(){
        if (instance == null){
            instance = new IptvPayHuBei();
        }
        return instance;
    }
    ...
    public void pay(int propId) {
        System.out.println(" ---- HuBei ---- public void pay() ---- propId = " + propId);
