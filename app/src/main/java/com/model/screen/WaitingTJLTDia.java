...
public class WaitingTJLTDia implements DialogInterface {
	...
	public WaitingTJLTDia() {
		isRunning = true;

		try {
			waitImg = Image.createImage("/pay/tjlt/zj_tips.png");
		} catch (IOException e) {
	...
	public void paint(Graphics g) {
		...
		StringTools.drawString("正在购买中，请稍后", 10, height/2, width - 20, strFont,
				0x000000, g);
		g.translate(-pos[0], -pos[1]);
	}
