...
public class L9Config {
	 ...
	 * 设置显示页面画图时间
	 */
	public static boolean bShowPaintTime = false;
	...
	public static boolean bShowObjectColAndDraw = false;
	/**
	 * 是否使用局部刷新 只在游戏当中执行该行为
	 */
	...
	/**
	 * 设置屏幕的宽,默认为L9Config.SCR_W
	 */
	public static int SCR_W = 1280;
	/**
	 * 设置屏幕的高,默认为L9Config.SCR_H
	 */
	 ...
	 * 每隔15帧回收一次内存
	 */
	public static int gcframe = 15;

	/**
	 * 是否及时回收内存
	 */
	public static boolean isgc = true;
